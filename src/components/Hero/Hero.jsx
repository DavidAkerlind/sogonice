  ...
  return (
    <section id="hem" className="sgn-hero">
      <div className="sgn-container sgn-hero__inner">
        ...
        >
          <span className="sgn-eyebrow">Naturligt fryst frukt & bär</span>
          ...
          <p className="sgn-hero__lead">
            Vi levererar färdigportionerade påsar med fryst frukt och bär till
            caféer och restauranger i hela Sverige. 17 smaker — noll krångel.
          </p>
          <div className="sgn-hero__cta">
            <a href="#kontakt" className="sgn-btn sgn-btn--primary">
